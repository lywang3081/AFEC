...
class Appr(object):
    ...
    def eval(self,t,x,y):
        ...
        for i in range(0,len(r),self.sbatch):
            ...
            loss=self.ce(output,targets) #self.criterion(t,output,targets)
            _,pred=output.max(1)
    ...
    def criterion_fg(self, t):
        ...
        if t > 0:
            ...
            #    if 'last' not in name:
            #        loss_reg += (1 - self.fg_matrix[name]) * self.surrogate_loss() #/ 2
        ...
        return self.c * loss_reg + self.lamb_emp * loss_reg_emp
